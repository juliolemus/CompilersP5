...
void Symbol::visitDeclarationNode(DeclarationNode* node)
{
    ...
    {
        varinfo2.offset=currentMemberOffset; //have to put both cases in  because we can increment both at the same time we have to be able to chose the right one
